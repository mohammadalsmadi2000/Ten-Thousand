...
class Siri(BaseBot):
    """
    A bot that rolls again if there are at least three dice remaining, 
    or banks points if there are fewer than three dice remaining.
    """

    def _roll_bank_or_quit(self):
        """
        Implements the logic for deciding whether to roll the dice, 
        bank the points, or quit the game. If there are at least three 
        dice remaining, returns 'r' to roll again; otherwise, returns 
    ...
    def _enter_dice(self):
        """
        Simulates the user entering which dice to keep. Defaults to keeping 
        all scoring dice.
        """
